...
print('Welcome to Rahman Troubleshooting Services Ltd. for Samsung.')
...
update = ('software', 'version', 'system software', 'updates', "can't update", 'not able to update', 'updating')
